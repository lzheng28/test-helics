...
if __name__ == "__main__":
    ...
    for t in range(0, total_inteval, pf_interval):
        ...
        for i in range(0, pubkeys_count):
            ...
            print("*******voltage_gld.real: ", voltage_gld.real, "*******voltage_gld.imag: ", voltage_gld.imag)
        ...
        print("!!!!!rload: ", rload * load_amplification_factor / 1000000, "  !!!!!iload: ", iload * load_amplification_factor / 1000000)
